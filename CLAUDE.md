...
| analytics.html | — | Password-gated LP analytics (TVPI/MOIC scatter chart) |
| tracker.html | — | Password-gated portfolio tracker dashboard (Plotly.js) |

### Gated Pages
- **analytics.html** — LP analytics with 3 tabs: TVPI scatter, MOIC scatter, Dashboard (20 Plotly charts from `dashboard_data.js`). Password: `Futurocompartido`. Dashboard data generated by `veronorteVIU/pipeline/publish_dashboard.py`.
- **tracker.html** — Full portfolio tracker with 6 tabs (Overview, FoF Metrics, Changes, Funds, Companies, Sectors). Password: `Futurocompartido`. Data source: `portfolio_data.js` (generated by `veronorteVIU/pipeline/publish.py`). FoF Metrics tab replicates investor report charts: capital committed/invested by fund, distribution by stage/type, vintage analysis, fund listing table with metadata.
